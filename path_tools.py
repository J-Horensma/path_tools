...
#FORMAT QUOTES IN THE SUPPLIED PATH,
#TO MATCH THE OS FORMATTING, REMOVES PREPENDED QUOTES,
#AS WELL AS THEIR MATCHING QUOTES, AT THE END OF THE PATH (IF EXISTENT),
#REPLACES OS-APPROPRIATE QUOTES, WITH OS-APPROPRIATE QUOTES,
#AND ADDS THE OS-APPROPRIATE QUOTES, IF THE PATH INCLUDES A SPACE
