...
**3.)** Creates a new directory, in the destination path, matching the source path's folder name, using the "os" module, if it does not already exists in the destination path,\
if it does exist, in the destination path, a new directory, with a new name, is created to copy the files to\
