...
**2.)** Calculates and displays the total number of files and bytes to be copied, from the SOURCE_PATH variable, using path_tools' built-in "recursive_files_and_bytes_total()" and "convert_bytes()" functions\
