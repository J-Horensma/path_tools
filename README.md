...
### **Description:**
**1.)** Filters and/or replaces quotes, OS variables, and dot-sequences, in the SOURCE_PATH or DESTINATION_PATH variables, passed to it, OS-appropriately, with path_tools' built-in "filter_path()", "appropriate_quotes()", and "unquote_path()" functions, as well as, the help of the "os", "platform", and "pathlib" modules\
...
### **Example**, using the **"path_tools"** library and the included test file **"recursive_copy_with_progress.py"**:
