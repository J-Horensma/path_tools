...
**4.)** Recursively copies all files and folders within the chosen source path, with the help of shutil, while displaying a live progress bar and an ETA, until finished, with path_tools' built-in "convert_seconds()" and the help of the "sys" module
