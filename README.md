...
**4.)** Recursively copies all files and folders within the chosen source path, with the help of shutil, while displaying a live progress bar and an ETA, until finished, with path_tools' built-in "recursive_copy_progress_bar()", "convert_seconds()" functions, and the help of the "sys" module
