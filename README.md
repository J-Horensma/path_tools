...
### **Description:**
**1.)** Filters and/or replaces characters, OS variables, and dot-sequences, in the SOURCE_PATH or DESTINATION_PATH variables, OS-appropriately, with the help of the "os" and "pathlib" modules\
