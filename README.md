...
### **Description:**
**1.)** Filters and/or replaces characters, OS variables, and dot-sequences, in the source path or destination path, OS-appropriately, with the help of the "os" and "pathlib" modules\
