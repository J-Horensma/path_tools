...
### **Description:**
**1.)** Removes and/or replaces OS-inappropriate, or unneccessary quotes, OS variables, and dot-sequences, in the SOURCE_PATH or DESTINATION_PATH variables, passed to it, OS-appropriately, with path_tools' built-in "filter_path()", "appropriate_quotes()", and "unquote_path()" functions, as well as, the help of the "os", "platform", and "pathlib" modules\
